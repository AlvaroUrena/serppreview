...
export default function Home() {
  return (
    <>
      ...
      <TOCContainer>
        <section className='container space-y-2 rounded-md bg-accent p-4'>
          <CheckCircle size={60} className='mx-auto mb-4' />
          <h2 className='text-center text-4xl font-bold'>
            Optimize Your Search Results
          </h2>
          <p className='rounded-md bg-background/70 p-2 text-xl'>
            Unlock the true potential of your web pages with SERP Preview. As
            the driving force behind online success, optimizing your content for
          ...
          <p className='rounded-md bg-background/70 p-2 text-xl'>
            ...
            capturing their attention. Meta titles and descriptions are your
            first impression – a chance to showcase your content&apos;s
            relevance. SERP Preview provides real-time glimpses of your search
            appearance, enabling you to refine your snippets for maximum impact.
          </p>
          <h3 className='text-2xl underline'>
            Supercharge Your Click-Through Rates
          </h3>
          <p className='rounded-md bg-background/70 p-2 text-xl'>
            With SERP Preview, take the driver&apos;s seat in crafting
            compelling search snippets. Fine-tune your meta elements to enhance
            click-through rates and drive organic traffic. Visualize how your
            page will appear in the dynamic search landscape, allowing you to
          ...
          <p className='rounded-md bg-background/70 p-2 text-xl'>
            ...
            strategic keywords and engaging calls to action. Witness firsthand
            how your tweaks influence your search presence and elevate your
            overall strategy.
          </p>
        </section>
        <section className='container mt-24 space-y-2 rounded-md bg-accent p-4'>
          <ClipboardEdit size={60} className='mx-auto mb-4' />
          <h2 className='text-center text-4xl font-bold'>
          ...
          <p className='rounded-md bg-background/70 p-2 text-xl'>
            In the digital realm, first impressions matter, and rich snippets
            are your secret weapon. SERP Preview empowers you to customize your
          ...
          <p className='rounded-md bg-background/70 p-2 text-xl'>
            ...
            Preview, sculpt your rich snippets to stand out. Highlight your
            unique selling points, whether it&apos;s stellar reviews,
            tantalizing recipes, or comprehensive lists. Let your content shine,
            compelling users to explore further.
          </p>
          <h3 className='text-2xl underline'>
          ...
          <p className='rounded-md bg-background/70 p-2 text-xl'>
            ...
            brilliance. Empower your content to seize attention and entice
            clicks, all before it goes live.
          </p>
        </section>
        <section className='container mt-24 space-y-2 rounded-md bg-accent p-4'>
          <MonitorCheck size={60} className='mx-auto mb-4' />
          <h2 className='text-center text-4xl font-bold'>
        ...
        <section className='container mt-24 space-y-2 rounded-md bg-accent p-4'>
          <Lightbulb size={60} className='mx-auto mb-4' />
          <h2 className='text-center text-4xl font-bold'>
          ...
          <p className='rounded-md bg-background/70 p-2 text-xl'>
            ...
            you to perfect your snippet lengths, ensuring they display
            flawlessly across devices and screen sizes. Avoid truncation woes
            and maintain a seamless, captivating presentation that beckons users
            to delve deeper.
          </p>
          <h3 className='text-2xl underline'>
          ...
          <p className='rounded-md bg-background/70 p-2 text-xl'>
            Seize the moment with strategic calls to action. SERP Preview
            enables you to infuse your rich snippets with compelling invitations
            that entice users to engage. From exploring your products to diving
            into your articles, tailor your calls to action to prompt meaningful
            interactions that drive results.
          </p>
          <h3 className='text-2xl underline'>A Glimpse into Success</h3>
          <p className='rounded-md bg-background/70 p-2 text-xl'>
            With SERP Preview as your compass, chart a course for search
            success. Witness firsthand how each tweak enhances your search
            appearance. Revel in the power of captivating meta elements,
            resonant keywords, and strategic calls to action. As you take the
            reins of your search destiny, savor the satisfaction of elevated
